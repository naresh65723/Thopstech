...
export default function Python() {
  ...
  return (
    <div className='py-20 md:mx-36 mx-10'>
      ...
      <h1 className='pt-8 text-2xl'>Python Full Stack Development</h1>
      ...
      <p className='mt-4'>This course will teach you how to do full stack development with the help of Python.</p>
    </div>
  )
}
